...
On the other hand, the prefix condition of $D^3$ allows for partial word movement, while still respecting certain linear order constraints, as observed in natural languages. Hence, it is reasonable to examine whether $D^3$ can also be modelled by a 2-MCFG. Such an endeavour proved quite challenging, necessitating careful study of correspondences with other mathematical constructs.
...
%suggesting the use of multi-dimensional Dyck languages in static analysis.
